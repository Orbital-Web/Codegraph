...
from codegraph.agent.deep_research.nodes.a1_analyze import analyze_intent
from codegraph.agent.deep_research.nodes.a2_plan import generate_plan
...
def build_graph() -> CompiledStateGraph[AgentState, None, AgentInput, AgentOutput]:
    ...
    graph.add_node(AgentStep.GENERATE_PLAN, generate_plan)
    ...
    graph.add_edge(AgentStep.ANALYZE_INTENT, AgentStep.GENERATE_PLAN)
    graph.add_edge(AgentStep.GENERATE_PLAN, AgentStep.CHOOSE_TOOLS)
